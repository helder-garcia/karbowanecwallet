// Copyright (c) 2012-2018, The CryptoNote developers, The Bytecoin developers, The Karbowanec developers, The Niobio developers
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 126; // addresses start with "K"
